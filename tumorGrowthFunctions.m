...
%
% Goal: Create a database of possible tumor growth laws both for primary and metastatic
%       growth, for lung and breast case studies
%
% Use: [g,gamma,be_m,vm]  = tumorGrowthFunctions(varargin)
%
...
%             cumulative number of metastases
%             g{3} kernel K(s,t) of the VIEs
%             g{4} weight function u(s) of the weighted space
%         gamma - upper limit of integration of the integral at the right-hand side of
%                 the VIE for computing the cumulative number of metastases
%         be_m - emission rate function for the metastases
%         vm - volume of the metastases
%
...
%--------------------------------------------------------------------------
function [g,gamma,be_m,vm]  = tumorGrowthFunctions(varargin)
...
be_p = @(t) emission_p.*t.^al;
% emission rate function for the metastases
be_m = @(t) emission_m.*t.^al;
